  ...
  return (
    <div style={{ background: pageBg, minHeight: '100vh', padding: '40px 0' }}>
      <div className="container" style={{ maxWidth: 800, margin: '0 auto' }}>
        <style>{`
          body[data-theme='dark'] .privacy-content h1,
          body[data-theme='dark'] .privacy-content h2,
          body[data-theme='dark'] .privacy-content h3,
          body[data-theme='dark'] .privacy-content h4,
          body[data-theme='dark'] .privacy-content h5,
          body[data-theme='dark'] .privacy-content h6 {
            color: #fff !important;
          }
        ...
        <div style={{
          ...
          <h1 style={{ fontSize: '2rem', margin: 0, color: titleColor }}>{t('privacy.title')}</h1>
          <div
