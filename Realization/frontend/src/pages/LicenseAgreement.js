...
const LicenseAgreement = () => {
  ...
  const textColor = dark ? '#ffffff' : '#23272f';
  ...
  return (
    <div style={{ background: pageBg, minHeight: '100vh', padding: '40px 0' }}>
      <div className="container" style={{ maxWidth: 800, margin: '0 auto' }}>
        <style>{`
          body[data-theme='dark'] .license-content h1,
          body[data-theme='dark'] .license-content h2,
          body[data-theme='dark'] .license-content h3,
          body[data-theme='dark'] .license-content h4,
          body[data-theme='dark'] .license-content h5,
          body[data-theme='dark'] .license-content h6 {
            color: #fff !important;
          }
          body[data-theme='dark'] .license-content {
        ...
        >
          <h1 style={{ fontSize: '2rem', margin: 0, color: titleColor }}>
            {t('license_agreement')}
          </h1>
          ...
          >
            <h2 style={{ fontSize: '21px', margin: '0.5rem 0', textAlign: 'left' }}>
              1. {t('introduction')}
            </h2>
