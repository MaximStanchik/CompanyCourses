...
const FAQ = () => {
  ...
  const fieldColor = dark ? '#f8fafc' : '#23272f';
  const questionColor = dark ? '#b6d4fe' : '#3976a8';
  ...
  return (
    <div style={{ background: pageBg, minHeight: '100vh', padding: '40px 0' }}>
      <div className="container" style={{ maxWidth: 800, margin: '0 auto' }}>
        <style>{`
          body[data-theme='dark'] .faq-content h1,
          body[data-theme='dark'] .faq-content h2,
          body[data-theme='dark'] .faq-content h3,
          body[data-theme='dark'] .faq-content h4,
          body[data-theme='dark'] .faq-content h5,
          body[data-theme='dark'] .faq-content h6 {
            color: #fff !important;
          }
          ...
          body[data-theme='dark'] .faq-content .toc,
          body[data-theme='dark'] .faq-content .toc *,
          body[data-theme='dark'] .faq-content .toc h2,
          body[data-theme='dark'] .faq-content .toc h3,
          body[data-theme='dark'] .faq-content .toc h4 {
            color: #111 !important;
          }
          body[data-theme='dark'] .faq-content {
            color: #fff !important;
        ...
        <div style={{ background: formBg, borderRadius: 16, boxShadow: dark ? '0 2px 8px rgba(0,0,0,0.12)' : '0 2px 8px rgba(0,0,0,0.04)', padding: 32 }}>
          <h1 style={{ fontSize: '2rem', margin: 0, color: titleColor }}>{t('faq.title')}</h1>
          <div className="faq-content" style={{ marginTop: '1.5rem', fontSize: '1.1rem', lineHeight: '1.6', color: fieldColor }}
            dangerouslySetInnerHTML={{ __html: t('faq.content') }} />
        </div>
      </div>
    </div>
  );
