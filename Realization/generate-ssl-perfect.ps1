Write-Host "Generating perfect SSL certificate for localhost..." -ForegroundColor Green
...
# Create configuration file for certificate with proper SAN
$opensslConfig = @"
[req]
...
Write-Host "Generating certificate with proper SAN..." -ForegroundColor Yellow
...
Write-Host "Perfect SSL certificate generated successfully!" -ForegroundColor Green
Write-Host "Files created:" -ForegroundColor Cyan
Write-Host "   - backend/ssl/localhost.key (private key)" -ForegroundColor Cyan
Write-Host "   - backend/ssl/localhost.crt (certificate with proper SAN)" -ForegroundColor Cyan
